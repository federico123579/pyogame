    ...
    def defense_name(defense):
        if buildings.is_defenses(defense):
            if defense[0] == 401:
                ...
                return 'laser_cannon_light'
            elif defense[0] == 403:
                return 'laser_cannon_heavy'
            elif defense[0] == 404:
                return 'gauss_cannon'
            elif defense[0] == 405:
                return 'ion_cannon'
                ...
                return 'shield_dome_small'
            elif defense[0] == 408:
                return 'shield_dome_large'
            elif defense[0] == 502:
                return 'missile_interceptor'
            elif defense[0] == 503:
                return 'missile_interplanetary'
...
def price(technology, level=1):
    ...
    if ships.is_ship(technology):
        if technology[0] == 204:
            return multipli_resources([3000, 1000, 0], technology[1])
        elif technology[0] == 205:
            return multipli_resources([6000, 4000, 0], technology[1])
        elif technology[0] == 206:
            return multipli_resources([20000, 7000, 2000], technology[1])
        elif technology[0] == 207:
            return multipli_resources([45000, 15000, 0], technology[1])
        elif technology[0] == 215:
            return multipli_resources([30000, 40000, 15000], technology[1])
        elif technology[0] == 211:
            return multipli_resources([50000, 25000, 15000], technology[1])
        elif technology[0] == 213:
            return multipli_resources([60000, 50000, 15000], technology[1])
        elif technology[0] == 214:
            return multipli_resources([5000000, 4000000, 1000000], technology[1])
        elif technology[0] == 218:
            return multipli_resources([85000, 55000, 20000], technology[1])
        elif technology[0] == 219:
            return multipli_resources([8000, 15000, 8000], technology[1])
        elif technology[0] == 202:
            return multipli_resources([2000, 2000, 0], technology[1])
        elif technology[0] == 203:
            return multipli_resources([6000, 6000, 0], technology[1])
        elif technology[0] == 208:
            return multipli_resources([10000, 20000, 10000], technology[1])
        elif technology[0] == 209:
            return multipli_resources([10000, 6000, 2000], technology[1])
        elif technology[0] == 210:
            return multipli_resources([0, 1000, 0], technology[1])
        elif technology[0] == 217:
            return multipli_resources([2000, 2000, 1000], technology[1])

    if buildings.is_supplies(technology):
        if technology[0] == 1:
            return resources(metal=60 * 1.5 ** level, crystal=15 * 1.5 ** level)
        elif technology[0] == 2:
            return resources(metal=48 * 1.6 ** level, crystal=24 * 1.6 ** level)
        elif technology[0] == 3:
            return resources(metal=225 * 1.5 ** level, crystal=75 * 1.5 ** level)
        elif technology[0] == 4:
            return resources(metal=75 * 1.5 ** level, crystal=30 * 1.5 ** level)
        elif technology[0] == 12:
            return resources(900 * 1.8 ** level, 360 * 1.8 ** level, 180 * 1.8 ** level)
        elif technology[0] == 22:
            return resources(metal=1000 * 2 ** level)
        elif technology[0] == 23:
            return resources(metal=1000 * 2 ** level, crystal=500 * 2 ** level)
        elif technology[0] == 24:
            return resources(metal=1000 * 2 ** level, crystal=1000 * 2 ** level)
        elif technology[0] == 212:
            return multipli_resources([0, 2000, 500], technology[1])
        elif technology[0] == 217:
            return multipli_resources([2000, 2000, 1000], technology[1])

    if buildings.is_facilities(technology):
        if technology[0] == 14:
            return resources(400 * 2 ** level, 120 * 2 ** level, 200 * 2 ** level)
        elif technology[0] == 21:
            return resources(400 * 2 ** level, 200 * 2 ** level, 100 * 2 ** level)
        elif technology[0] == 31:
            return resources(200 * 2 ** level, 400 * 2 ** level, 200 * 2 ** level)
        elif technology[0] == 34:
            return resources(metal=20000 * 2 ** level, crystal=40000 * 2 ** level)
            ...
            return resources(metal=200 * 5 ** level, deuterium=50 * 5 ** level)
        elif technology[0] == 41:
            return resources(10000 * 2 ** level, 20000 * 2 ** level, 10000 * 2 ** level)
        elif technology[0] == 42:
            return resources(10000 * 2 ** level, 20000 * 2 ** level, 10000 * 2 ** level)
        elif technology[0] == 43:
            return resources(10000 * 2 ** level, 20000 * 2 ** level, 10000 * 2 ** level)

    if buildings.is_defenses(technology):
        if technology[0] == 401:
            return multipli_resources([2000, 0, 0], technology[1])
        elif technology[0] == 402:
            return multipli_resources([1500, 500, 0], technology[1])
        elif technology[0] == 403:
            return multipli_resources([6000, 2000, 0], technology[1])
        elif technology[0] == 404:
            return multipli_resources([20000, 15000, 2000], technology[1])
        elif technology[0] == 405:
            return multipli_resources([5000, 3000, 0], technology[1])
        elif technology[0] == 406:
            return multipli_resources([50000, 50000, 30000], technology[1])
        elif technology[0] == 407:
            return multipli_resources([10000, 10000, 0], technology[1])
        elif technology[0] == 408:
            return multipli_resources([50000, 50000, 0], technology[1])
        elif technology[0] == 502:
            return multipli_resources([8000, 2000, 0], technology[1])
        elif technology[0] == 503:
            return multipli_resources([12500, 2500, 10000], technology[1])

    if research.is_research(technology):
        if technology[0] == 113:
            return resources(crystal=800 * 2 ** level, deuterium=400 * 2 ** level)
        elif technology[0] == 120:
            return resources(metal=200 * 2 ** level, crystal=100 * 2 ** level)
        elif technology[0] == 121:
            return resources(1000 * 2 ** level, 300 * 2 ** level, 100 * 2 ** level)
        elif technology[0] == 114:
            return resources(crystal=4000 * 2 ** level, deuterium=2000 * 2 ** level)
        elif technology[0] == 122:
            return resources(2000 * 2 ** level, 4000 * 2 ** level, 1000 * 2 ** level)
        elif technology[0] == 115:
            return resources(metal=400 * 2 ** level, deuterium=600 * 2 ** level)
        elif technology[0] == 117:
            return resources(2000 * 2 ** level, 4000 * 2 ** level, 600 * 2 ** level)
        elif technology[0] == 118:
            return resources(10000 * 2 ** level, 20000 * 2 ** level, 6000 * 2 ** level)
        elif technology[0] == 106:
            return resources(200 * 2 ** level, 1000 * 2 ** level, 200 * 2 ** level)
            ...
            return resources(metal=200 * 2 ** level, crystal=600 * 2 ** level)
        elif technology[0] == 111:
            return resources(metal=1000 * 2 ** level)
